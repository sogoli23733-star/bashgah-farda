   ...
   <body bgcolor="14213d" align="center">
     <div style="width:500px; height:550px; margin:auto; border:solid 1px black;
      ...
      for($i = 0; $i <= 8; $i++){
        ...
        ?>
        <img src="image/<?=$picNumber?>.jpg"width="150" height="150" onclick="getcurrentPic(this)" />
      <?php } ?>
      <br><input type="button" style="font-family:IRANSans;margin-top:15px;height:40px;width:100px;border-radius:30px;"
